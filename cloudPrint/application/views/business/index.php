...
<head>
    ...
    <script type="text/javascript">
        ...
        function logout(){
            if(confirm("您确定要退出本系统吗？")){
                window.location.href = "<?php echo site_url('business/index/logout'); ?>";
            }
        }
    ...
    <script type="text/javascript">
        ...
        function loadMenu(resourceType, treeObj){
            ...
            var deg = "<?php echo $this->session->userdata('class');?>";
            if(deg == 0){
                data1 = [{"accessPath":"","checked":false,"delFlag":0,"parentID":1,"resourceCode":"","resourceDesc":"","resourceGrade":2,"resourceID":3,"resourceName":"店铺管理","resourceOrder":0,"resourceType":""},
                    {"accessPath":"<?php echo site_url('business/shop_manage/shop_info'); ?>","checked":false,"delFlag":0,"parentID":3,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":7,"resourceName":"店铺信息","resourceOrder":0,"resourceType":""},
                    {"accessPath":"<?php echo site_url('business/shop_manage/set_location_view'); ?>","checked":false,"delFlag":0,"parentID":3,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":17,"resourceName":"位置定位","resourceOrder":0,"resourceType":""},
                    {"accessPath":"<?php echo site_url('business/shop_manage/set_price'); ?>","checked":false,"delFlag":0,"parentID":3,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":22,"resourceName":"价格设置","resourceOrder":0,"resourceType":""},
                    {"accessPath":"<?php echo site_url('business/shop_manage/get_order_list'); ?>","checked":false,"delFlag":0,"parentID":3,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":8,"resourceName":"订单管理","resourceOrder":0,"resourceType":""},
                    {"accessPath":"<?php echo site_url('business/shop_manage/get_comment_list'); ?>","checked":false,"delFlag":0,"parentID":3,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":32,"resourceName":"客户反馈","resourceOrder":0,"resourceType":""},
                    {"accessPath":"","checked":false,"delFlag":0,"parentID":1,"resourceCode":"","resourceDesc":"","resourceGrade":2,"resourceID":7,"resourceName":"商户账户管理","resourceOrder":0,"resourceType":""},
                    {"accessPath":"<?php echo site_url('business/shop_manage/change_psw'); ?>","checked":false,"delFlag":0,"parentID":7,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":38,"resourceName":"修改密码","resourceOrder":0,"resourceType":""}];
            }else if(deg == 1){
                data1 = [{"accessPath":"","checked":false,"delFlag":0,"parentID":1,"resourceCode":"","resourceDesc":"","resourceGrade":2,"resourceID":3,"resourceName":"打印管理","resourceOrder":0,"resourceType":""},
                    {"accessPath":"<?php echo site_url('business/shop_manage/shop_info'); ?>","checked":false,"delFlag":0,"parentID":3,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":7,"resourceName":"运营信息","resourceOrder":0,"resourceType":""},
                    {"accessPath":"<?php echo site_url('business/shop_manage/get_gov_order_list'); ?>","checked":false,"delFlag":0,"parentID":3,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":8,"resourceName":"订单管理","resourceOrder":0,"resourceType":""},
                    {"accessPath":"","checked":false,"delFlag":0,"parentID":1,"resourceCode":"","resourceDesc":"","resourceGrade":2,"resourceID":7,"resourceName":"账号管理","resourceOrder":0,"resourceType":""},
                    {"accessPath":"<?php echo site_url('business/shop_manage/create_code'); ?>","checked":false,"delFlag":0,"parentID":7,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":18,"resourceName":"生成二维码","resourceOrder":0,"resourceType":""},
                    {"accessPath":"<?php echo site_url('business/shop_manage/staff_list'); ?>","checked":false,"delFlag":0,"parentID":7,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":20,"resourceName":"员工管理","resourceOrder":0,"resourceType":""},
                    {"accessPath":"<?php echo site_url('business/shop_manage/change_psw'); ?>","checked":false,"delFlag":0,"parentID":7,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":38,"resourceName":"修改密码","resourceOrder":0,"resourceType":""}];
        ...
        <div id="top_op">
            <ul>
                <li>
                    ...
                    <span><?php echo $this->session->userdata('shopName'); ?></span>
                </li>
                <li>
    ...
    <div id="left_menu">
        <ul id="TabPage2" style="height:200px; margin-top:50px;">
            <li id="left_tab1" class="selected" onClick="javascript:switchTab('TabPage2','left_tab1');" title="功能模块">
                <img alt="功能模块" title="功能模块" src="<?php echo base_url(); ?>images/common/hover.png" width="41" height="34">
            </li>
...
<script type="text/javascript">
    $(function(){
        $('#TabPage2 li').click(function(){
            ...
            $(this).find('img').attr('src', '<?php echo base_url(); ?>images/common/'+ (index+1) +'_hover.jpg');
...
<div id="main">
    <iframe name="right" id="rightMain" src="<?php echo site_url('business/index/system_introduce'); ?>" frameborder="no" scrolling="auto" width="100%" height="100%" allowtransparency="true"/>
</div>
