        ...
        $(document).ready(function() {
            ...
            $("#submitButton").click(function() {
                if(checkMobilePhone() && checkEmail()){
                    $.ajax({
                        url : "<?php echo site_url('business/shop_manage/add_staff') ?>",
...
<form id="form1" >
    ...
    <div id="container">
        <div id="nav_links">
            当前位置：新增员工&nbsp;>&nbsp;<span style="color: #1A5CC6;">员工信息编辑</span>
            <div id="page_close">
        ...
        <div id="form_box">
            ...
            <div class="form_content">
                <label>手机号:</label>
                <input type="text" id="userPhone" name="userPhone" maxlength="11" onblur="checkMobilePhone()" >
            </div>
