...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	function checkAddress(){
		if($('#businessAddress').val()){
	            ...
	            layer.tips('请输入地址！','#businessAddress',{
	                tips:3,
	                time:1500
	            });
	            return false;
					...
					<div id="form_box">
						...
						<div class="one">
							<div class="form">
								...
								<input type="text" name="businessNick" id="businessNick" placeholder="请输入汉字、字母、数字" maxlength="20" value="" onblur="checkNick();" />
							</div>
						</div>
						...
						<div class="one">
							<div class="form">
								<span>店铺名称<font color="red">*</font>：</span>
