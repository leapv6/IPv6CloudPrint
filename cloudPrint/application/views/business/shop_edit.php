...
<div id="form_box">
    <form  id="submitForm" name="submitForm">
        ...
        <div class="form_content">
            <label>性&nbsp;&nbsp;&nbsp;&nbsp;质：</label>
            <input type="text" id="property" name="property" value="<?php echo $property ?"自然人经营" :"工商经营"?>" disabled/>
        </div>

        <div class="form_content">
            <label>邮&nbsp;&nbsp;&nbsp;&nbsp;箱：</label>
            <input type="text" id="businessEmail" name="businessEmail" value="<?php echo $businessEmail;?>" onblur="checkEmail()"/>
        </div>
        ...
        <div class="form_textarea">
            <label>店铺信息：</label>
            <textarea style="height: 100px;width:160px" id="schoolName" name="shopInfo"   class="ui_input_txt01"><?php echo $shopInfo;?></textarea>
        </div>
