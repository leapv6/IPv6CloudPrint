    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            $("#submitButton").click(function(){
                if(checkNumber() && checkSpecial() && checkNumber1()){
                    $.ajax({
                            ...
                            if(data.status == 1){
                                if(data.class == 0){
                                    ...
                                    layer.open({
                                        type: 2,
                                        title:false,
                                        content:'<?php echo site_url("user/user_index/show_qrcode") ?>'+'/'+data.order_id,
                                        border : [5, 0.5, '#666'],
                                        area: ['520px','500px'],
                                        shadeClose: true
                                    });
...
<div id="form_box">
    <form  id="form1">
        ...
        <div class="form_radio">
            ...
            <ul>
                <li><input type="radio" value="0" checked  name="sendType" data-labelauty="上门自取"></li>
                <li><input type="radio" value="1"  name="sendType" data-labelauty="商家配送"></li>
            </ul>
        </div>
        ...
        <div class="form_content" >
            <label class="center1">文档页数：</label>
            <input type="text" id="pageNum" name="pageNum" style="margin-bottom: 10px;" value="" placeholder="请输入要打印的页数(默认1页)" maxlength="4" onkeyup="get_price()"  onblur="checkNumber1();"/>
        </div>
        ...
        <div class="form_content" >
            <div style="display: inline-block;width: 320px;">
                <font style="font-family: 微软雅黑;margin-top: 40px;" >价 格：</font>
                <font color="red" style="font-family: 微软雅黑;display:inline-block;float: right;" id="price"><?php echo $price; ?>元</font>
            </div>
