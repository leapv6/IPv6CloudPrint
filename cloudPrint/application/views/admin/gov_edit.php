...
<head>
    ...
    <script type="text/javascript">
        ...
        function check_all(){
            if(checkNick() && checkName() && checkShopName() && checkAddress() && checkPass() && checkEmail()){
                $.ajax({
                    url : "<?php echo site_url('admin/gov/gov_update') ?>",
    ...
    <div id="left">
        ...
        <div id="left_mid">
            <div id="left_content">
                ...
                <form id="form1">
                    <input value="<?php echo $businessId ?>" type="hidden" name="businessId" />
                    <div id="form_box">
                        <div class="one">
                            <div class="form">
                                <span>手机号<font color="red">*</font>：</span>
                                <input value="<?php echo $businessPhone ?>" type="text" disabled="disabled" name="businessPhone" placeholder="请输入手机号" id="businessPhone" maxlength="11"  />
                            </div>
                        ...
                        <div class="one">
                            <div class="form">
                                ...
                                <input type="text" name="businessNick" id="businessNick" placeholder="请输入汉字、字母、数字" maxlength="70" value="<?php echo $businessNick ?>" onblur="checkNick();" />
                            </div>
                        </div>
                        ...
                        <div class="one">
                            <div class="form">
                                ...
                                <input value="<?php echo $businessName ?>" type="text" name="businessName" id="businessName" maxlength="20" onblur="checkName();"  />
                            </div>
                        ...
                        <div class="one">
                            <div class="form">
                                ...
                                <input type="text" name="shopName" id="shopName" placeholder="请输入单位的全称"  value="<?php echo $shopName ?>" maxlength="70" onblur="checkShopName();" />
                            </div>
                        ...
                        <div class="one">
                            <div class="form">
                                ...
                                <input value="<?php echo $businessAddress ?>" type="text" name="businessAddress" placeholder="请输入单位的街道地址" id="businessAddress" size="30" maxlength="70" onblur="checkAddress();" />
                            </div>
                        ...
                        <div class="one">
                            <div class="form">
                                ...
                                <input type="text" name="businessEmail"  id="businessEmail" maxlength="50"  value="<?php echo $businessEmail ?>" onblur="checkEmail();" />
                            </div>
